      ...
      <section className="bg-black h-screen sectionFondoForm">
        <div className="flex h-[calc(100vh-100px)] items-center justify-center">
          <div className="bg-zinc-900 max-w-md w-full p-12 rounded-md">
            ...
            <i class="bi bi-person-add text-sky-500 text-6xl flex justify-center p-3"></i>
            ...
            >
              ...
              <div className="text-center p-2">
                ...
                <Link to="/inicio" className="text-sky-500">
                  Iniciar Sesión
                </Link>
              </div>
              <div className="flex justify-around p-2">
                ...
                <button type="submit" className="text-sky-500">
                  <i class="bi bi-house text-1xl"></i> Registrarse
                </button>
              </div>
            </form>
          </div>
